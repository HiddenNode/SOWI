...
lighting: $(obj)/main.o $(obj)/program.o $(obj)/shader.o $(obj)/shader.o $(obj)/camera.o $(obj)/light.o $(obj)/resourceHandler.o $(obj)/eventHandler.o $(obj)/helper.o $(obj)/commands.o $(obj)/commandHandler.o
...
$(obj)/resourceHandler.o: $(src)/resourceHandler.cpp $(hdr)/resourceHandler.hpp
